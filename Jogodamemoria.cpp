...
{
      int contt;
      system("title Jogo da memoria / Por:Rafael E Guilherme");
      start();
      selecao();
      gol();
      inst();
...
printf("\n\n\n\n\n\n\n\n\n\n\n");
printf("\t****************************************************************\n");
printf("\t**        desenvolvido por: Rafael E Guilherme        **\n");
printf("\t**      Desenvolvido em prol do conhecimento em linguagem C      **\n");
